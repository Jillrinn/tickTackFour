...
- [ ] 3. ローカル環境での動作確認とテストを実施する
- [ ] 3.1 Azure Functions APIを起動し動作を確認
...
- [ ] 4. 既存ユニットテストを実行し回帰検証する
- [ ] 4.1 バックエンドのユニットテストを実行
  - api/ディレクトリで`npm test`を実行
  - 全テストがパスすることを確認
  - テスト失敗がある場合は原因を調査し修正
  - _Requirements: 1.2_

- [ ] 4.2 フロントエンドのユニットテストを実行
