...
- [ ] 2.1 ゲーム状態取得エンドポイントの実装（GET /api/game）
...
- [ ] 2.2 ターン切り替えエンドポイントの実装（POST /api/switchTurn）
...
- [ ] 2.3 一時停止エンドポイントの実装（POST /api/pause）
